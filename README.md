...
- Moyu currently downloads but does not echo on CentOS 7 (thanks for reporting by Irene), likely because the bash on old linux is not compatible with [```line 28```](https://github.com/chenh19/moyu/blob/b8cc644f170d18c04f3692b476e40b9c87414176/linux_moyu.sh#L28) (both [```line 27```](https://github.com/chenh19/moyu/blob/55610cddad4652eb58a9b2b926552fc37251f896/linux_moyu.sh#L27) and [```line 29```](https://github.com/chenh19/moyu/blob/55610cddad4652eb58a9b2b926552fc37251f896/linux_moyu.sh#L29) work)
